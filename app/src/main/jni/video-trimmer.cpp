...
//#includeffmpeg/include/ <libswscale/swscale.h>
...
//extern "C" void register_exit(void (*cb)(int ret));
...
JNIEXPORT jint JNICALL Java_cn_com_wanyueliang_tomato_utils_ffmpeg_VideoTrimmerService_trim(
    ...
    log_message("--------FFmpeg init1---------");

    g_obj = env->NewGlobalRef(obj);
    log_message("--------FFmpeg init2---------");

    av_log_set_callback(av_log_callback);
    log_message("--------FFmpeg init3---------");

...
static void (*program_exit_callback)(int ret);

void register_exit_callback(void (*cb)(int ret))
{
	program_exit_callback = cb;
}
...
void exit_program(int ret)
{
    if (program_exit)
        program_exit(ret);
	if(program_exit_callback)
    {
    	program_exit_callback(ret);
    }
    exit(ret);
}
